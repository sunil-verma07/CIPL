...
// All social icons as inline SVGs — no lucide dependency
const XIcon = () => (
      ...
      <div className="py-14 px-6" style={{ borderBottom: '1px solid #EEEBE8' }}>
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h4 className="text-[17px] font-[500] mb-2" style={{ color: '#653C1A' }}>
              Our Portfolio
            </h4>
            <ul className="">
              {FOOTER_PORTFOLIO.map(item => (
                <li key={item}>
                  <Link to="/brands" className="text-[13px] transition-colors hover:text-[#1A3EBD]" style={{ color: '#717171' }}>
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="">
              {FOOTER_COMPANY.map(item => (
                <li key={item}>
                  <Link to="/about" className="text-[13px] transition-colors hover:text-[#1A3EBD]" style={{ color: '#717171' }}>
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <motion.div variants={itemVariants} className="flex  flex-col items-start md:items-end gap-2">
            <span className="text-[22px] mr-12 font-bold tracking-tight" style={{ color: '#0047AB' }}>
              Crediple
            </span>
            <img src={logo} className="w-28 mr-8" alt="YAKA logo" />
